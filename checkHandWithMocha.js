...
function isStraight(hand) {
  return cardInSequence(valuesFromHand(hand))
}

function cardInSequence(values) {
...
describe('isPair()', () => {
  it('finds a pair', () => {
    var result = isPair(['2-H', '3-C', '3-D', '5-H', '2-H'])
    wish(result)
  })
})
...
describe('allTheSameSuit()', function () {
  ...
  it('reports fales if not all elements are the same', () => {
    var result = allTheSameSuit(['H', 'D', 'D', 'D', 'D']);
    wish(result === false)
  })
});
